...
import com.tungfnq.config.DbPropertySourcesPlaceholderConfigurer;
 ...
 * 
 */
public final class DBEncryptablePropertySourcesPlaceholderConfigurer 
        extends DbPropertySourcesPlaceholderConfigurer {
	 ...
	 *            can not be null.
	 */
	public DBEncryptablePropertySourcesPlaceholderConfigurer(
	 ...
	 *            not be null.
	 */
	public DBEncryptablePropertySourcesPlaceholderConfigurer(final TextEncryptor textEncryptor) {
		super();
